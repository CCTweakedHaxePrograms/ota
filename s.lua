...
___Main_Main_Fields_.main = function() 
  ...
  tmp(Std.string("a: ") .. Std.string(Std.string(args)), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=4,className="_Main.Main_Fields_",methodName="main"}));
